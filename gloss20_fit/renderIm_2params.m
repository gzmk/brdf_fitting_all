...
writetable(T,'/scratch/gk925/brdf_fitting_all/gloss20_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit
...
imPath = ['/scratch/gk925/brdf_fitting_all/gloss20_fit/', hints.recipeName, '/renderings/Mitsuba/sphere-2param.mat']
