...
writetable(T,'/scratch/gk925/brdf_fitting_all/gloss80_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_all/gloss80_fit');
...
mappingsFile = '80gloss_DefaultMappings.txt';
...
imPath = ['/scratch/gk925/brdf_fitting_all/gloss80_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
...
load('registered80.mat') % make this a variable
