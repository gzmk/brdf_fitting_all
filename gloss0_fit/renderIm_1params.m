...
% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_all/gloss0_fit');
...
imPath = ['/scratch/gk925/brdf_fitting_all/gloss0_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
