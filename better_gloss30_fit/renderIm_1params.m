...
writetable(T,'/scratch/gk925/brdf_fitting_all/gloss30_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit
...
imPath = ['/scratch/gk925/brdf_fitting_all/gloss30_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
